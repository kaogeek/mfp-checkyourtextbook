import { c as create_ssr_component, g as getContext, b as add_attribute, e as escape, d as compute_rest_props, s as setContext, f as validate_dynamic_element, h as validate_void_dynamic_element, i as spread, j as escape_object, k as escape_attribute_value, l as is_void, n as noop, o as each, v as validate_component, p as compute_slots, q as createEventDispatcher } from '../../chunks/index.js';
import classNames from 'classnames';
/* empty css                                                    */import { S as Swiper_1, a as Swiper_slide, I as Img, P } from '../../chunks/Searcher.svelte_svelte_type_style_lang.js';
...
const Frame = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	return `${(tag$1 => {
		...
		? (() => {
				...
				return `<${tag}${spread([escape_object($$restProps), { class: escape_attribute_value(divClass) }], {})}${add_attribute("this", node, 0)}>${is_void(tag$1)
				? ''
...
const arrowDowmIcon = "/_app/immutable/assets/arrow-down-7d5b0021.svg";

/* src/lib/shared/ui/components/swiper/class/SwiperClass.svelte generated by Svelte v3.50.1 */

const SwiperClass = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	let { items = [] } = $$props;
	if ($$props.items === void 0 && $$bindings.items && items !== void 0) $$bindings.items(items);
			...
			default: () => {
				return `${each(items, item => {
					return `${validate_component(Swiper_slide, "SwiperSlide").$$render(
						$$result,
						{
							class: "rounded-2xl cursor-pointer flex flex-col"
						},
						{},
						{
							default: () => {
...
const Header = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	if ($$props.isOpenModalCreate === void 0 && $$bindings.isOpenModalCreate && isOpenModalCreate !== void 0) $$bindings.isOpenModalCreate(isOpenModalCreate);
	if ($$props.scrollY === void 0 && $$bindings.scrollY && scrollY !== void 0) $$bindings.scrollY(scrollY);
	let $$settled;
	let $$rendered;
	...
	do {
		...
		$$rendered = `<div class="${"sticky w-full z-20 top-0 left-0"}"><nav class="${escape(scrollY > 1 ? 'shadow-md' : '', true) + " bg-white px-2 sm:px-4 py-2.5 relative"}"><div class="${"flex flex-wrap justify-between items-center mx-auto"}"><a href="${"/"}" class="${"flex items-center min-w-[90px]"}"><img${add_attribute("src", logo, 0)} class="${"mx-2 h-8 sm:h-7"}" alt="${"Checkyourtextbook Logo"}"></a>

      <div class="${"absolute bottom-0 left-1/2 translate-x-[-50%]"}"><div class="${"after:bg-[url(" + escape(arrowDowmIcon, true) + ")] after:absolute after:bottom-0 after:h-3 mt-2 text-[13px] bg-gray-200 h-11 flex items-center justify-center rounded-t-lg px-3 cursor-pointer text-gray-600 select-none"}">ทุกระดับการศึกษา
        </div></div>

      <div class="${"flex min-w-[90px]"}"><div class="${"hidden md:block"}"><button type="${"button"}" class="${"mx-2 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2 text-center"}">สร้าง</button></div></div></div></nav>
  
  <div class="${escape('h-0', true) + " " + escape(scrollY > 1 ? 'shadow-md' : '', true) + " overflow-hidden flex justify-center duration-300 bg-gray-200"}"><div class="${"flex items-center p-3 w-[100%] sm:w-[60%]"}">${validate_component(SwiperClass, "SwiperClass").$$render(
			$$result,
			{ items: primaryClass },
			{
				items: $$value => {
...
<main class="${"mt-2 s-7IPF32Wcq3s8"}"><section class="${"p-4 s-7IPF32Wcq3s8"}">${slots.default ? slots.default({}) : ``}</section></main>
