...
const Searcher = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	return `<div class="${"bg-searcher bg-center bg-no-repeat rounded-2xl flex flex-col justify-center self-center s-54JR_X_9pYjX"}"><div class="${"px-5 sm:px-28 md:px-42 lg:px-72 text-center s-54JR_X_9pYjX"}"><h1 class="${"text-white text-2xl mb-5 s-54JR_X_9pYjX"}">เรื่องบ้งในการศึกษาไทย ยังเกิดขึ้นได้ทุกวัน
    </h1>
    <div class="${"relative s-54JR_X_9pYjX"}">

      ${validate_component(InputIcon, "InputIcon").$$render(
		$$result,
		{
...
<section class="${"mt-8"}">${validate_component(SwiperSubject, "SwiperSubject").$$render($$result, { items: data.subjects }, {}, {})}</section>
