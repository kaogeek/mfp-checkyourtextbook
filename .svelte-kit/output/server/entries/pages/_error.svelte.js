import { c as create_ssr_component, d as compute_rest_props, g as getContext, f as validate_dynamic_element, h as validate_void_dynamic_element, i as spread, k as escape_attribute_value, j as escape_object, l as is_void, b as add_attribute, r as validate_store, t as subscribe, e as escape, v as validate_component } from '../../chunks/index.js';
import classNames from 'classnames';
/* empty css                                                    */
/* node_modules/flowbite-svelte/buttons/Button.svelte generated by Svelte v3.50.1 */
...
const Button = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	function rounded(gradientOutline = false) {
		...
		return pill
		? 'rounded-full'
		: gradientOutline ? 'rounded-md' : 'rounded-lg';
	}
	...
	gradientOutlineClass = classNames('inline-flex items-center justify-center', sizeClasses[size], rounded(true), 'bg-white text-gray-900 dark:bg-gray-900 dark:text-white', 'transition-all duration-75 ease-in group-hover:bg-opacity-0 group-hover:text-inherit'); // this is limitation - no transparency
	...
	return `${(tag => {
		...
		? (() => {
				...
				: `${outline && gradient
					? `
    <span${add_attribute("class", gradientOutlineClass, 0)}>${slots.default ? slots.default({}) : ``}</span>`
