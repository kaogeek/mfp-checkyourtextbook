import { c as create_ssr_component, h as getContext, g as add_attribute, i as escape, b as compute_rest_props, s as setContext, l as validate_dynamic_element, o as validate_void_dynamic_element, d as spread, e as escape_object, f as escape_attribute_value, p as is_void, n as noop, v as validate_component, q as createEventDispatcher, k as compute_slots } from "./index.js";
...
const Frame = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  let { transition: transition2 = void 0 } = $$props;
  let { params = {} } = $$props;
  ...
  return `${((tag$1) => {
    ...
    return tag$1 ? (() => {
      ...
      return `<${tag}${spread([escape_object($$restProps), { class: escape_attribute_value(divClass) }], {})}${add_attribute("this", node, 0)}>${is_void(tag$1) ? "" : `${slots.default ? slots.default({}) : ``}`}${is_void(tag$1) ? "" : `</${tag$1}>`}`;
    })() : "";
  })(tag)}`;
});
const Badge = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  badgeClass = classNames(
    ...
    index2 && "absolute font-bold border-2 border-white dark:border-gray-900",
    index2 && (large ? "w-7 h-7 -top-3 -right-3" : "w-6 h-6 -top-2 -right-2"),
    $$props.class
  );
  return `${((tag) => {
...
const Iconinput = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  let { inputClass = "rounded-none rounded-r-lg bg-gray-50 border border-gray-300 text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full border-gray-300 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" } = $$props;
  let { spanClass = "inline-flex items-center px-3 text-sm text-gray-900 bg-gray-200 rounded-l-md border border-r-0 border-gray-300 dark:bg-gray-600 dark:text-gray-400 dark:border-gray-600" } = $$props;
  let { noBorderInputClass = "bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full   dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" } = $$props;
  let { pointerEvent = false } = $$props;
  let { noBorderDivClass = "flex absolute inset-y-0 left-0 items-center pl-3" } = $$props;
  ...
  if ($$props.noBorderInputClass === void 0 && $$bindings.noBorderInputClass && noBorderInputClass !== void 0)
    $$bindings.noBorderInputClass(noBorderInputClass);
  if ($$props.pointerEvent === void 0 && $$bindings.pointerEvent && pointerEvent !== void 0)
    $$bindings.pointerEvent(pointerEvent);
  if ($$props.noBorderDivClass === void 0 && $$bindings.noBorderDivClass && noBorderDivClass !== void 0)
    $$bindings.noBorderDivClass(noBorderDivClass);
  return `${noBorder ? `<div class="${"relative"}"><div${add_attribute(
    "class",
    classNames(
      noBorderDivClass,
      {
    ...
    {}
  )}${add_attribute("value", value, 0)}></div>` : `<div class="${"flex"}"><span${add_attribute("class", spanClass, 0)}>${slots.default ? slots.default({}) : ``}</span>
		<input${spread(
    [
      escape_object($$restProps),
      {
...
<div tabindex="${"-1"}" class="${[
  ...
  ].join(" ").trim()}"${add_attribute("aria-hidden", open ? void 0 : "true", 0)}${add_attribute("aria-modal", open ? "true" : void 0, 0)}${add_attribute("role", open ? "dialog" : void 0, 0)}><div class="${"relative p-4 w-full " + escape(sizes[size], true) + " h-full md:h-auto"}">
      ...
      default: () => {
        return `
			${$$slots.header || title ? `<div class="${"flex justify-between items-center p-4 rounded-t border-b dark:border-gray-600"}">${slots.header ? slots.header({}) : `
					...
					`}
					${validate_component(CloseButton, "CloseButton").$$render($$result, { name: "Close modal" }, {}, {})}</div>` : `${validate_component(CloseButton, "CloseButton").$$render(
          $$result,
          {
            name: "Close modal",
