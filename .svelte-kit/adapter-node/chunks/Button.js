import { c as create_ssr_component, b as compute_rest_props, h as getContext, l as validate_dynamic_element, o as validate_void_dynamic_element, d as spread, f as escape_attribute_value, e as escape_object, p as is_void, g as add_attribute } from "./index.js";
...
const Button = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  buttonClass = btnClass ? btnClass : classNames(
    ...
    color === "alternative" && (background ? "dark:bg-gray-700 dark:text-white dark:border-gray-700 dark:hover:border-gray-600 dark:hover:bg-gray-600" : "dark:bg-transparent dark:border-gray-800 dark:hover:border-gray-700"),
    outline && color === "dark" && (background ? "dark:text-white dark:border-white" : "dark:text-gray-400 dark:border-gray-700"),
